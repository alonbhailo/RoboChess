...
class app_callback_class:
    def __init__(self):
        ...
        self.edited_frame_queue = multiprocessing.Queue(maxsize=3)
        self.running = True
    ...
    def get_edited_frame(self):
        if not self.edited_frame_queue.empty():
            return self.edited_frame_queue.get()
        else:
            return None
